...
cd /home/vagrant
# Setting up stuffs
sudo apt install curl wget git zsh python3-pip tmux neovim vim gpg
...
sudo apt install radare2 john binwalk nmap sublist3r gobuster gdb hashcat bettercap exif python3-venv
